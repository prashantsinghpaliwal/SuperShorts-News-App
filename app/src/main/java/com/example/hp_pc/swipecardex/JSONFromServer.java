...
public class JSONFromServer {
    ...
    private static ArrayList<News> extractEarthquakesFromJSON(String jsonResponse) {
        ...
        try {
            ...
            JSONArray articlesArray = sampleJSON.getJSONArray("articles");
            for (int i = 0; i < articlesArray.length(); i++) {
                ...
                news.add(new News(title, desc, imageUrl, author,url));
